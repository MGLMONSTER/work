<template>
  <div class="appmain-right">
    ...
    <div class='tab-div'>
      <div class='app-table'
           style="margin-left:5px;margin-top:5px;width:auto; padding:20px;border:1px solid #f5f7fa; height:90%;">
        ...
        <div class="filter-input">
          ...
          <el-button class="filter-item" type="primary" size="small" icon="search" @click="handleFilter"><span
            style="font-size:14px;">{{$t('table.sousu')}}</span></el-button>
        ...
        <el-table :key='tableKey' :data="list" border fit highlight-current-row style=" margin-left:10px;">
          ...
          <el-table-column align="center" :label="$t('table.ccaoz')" width="30%">
            <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :show-close="false"
      ...
      <el-form :model="form" :rules="rules" ref="form">
        ...
        <el-input v-model="form.total" placeholder="请输入统计"></el-input>
          ...
          <el-form-item label="ᠪᠠᠶᠢᠳᠠᠯ " prop="status">
            ...
            <el-select class="setselectss" v-model="form.status">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="cancel('form')" type="primary" size="small">{{$t('table.quxiao')}}</el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        statusOptions: [{ value: 0, status: 'ᠡᠬᠢᠯᠡᠨ ᠬᠡᠷᠡᠭᠯᠡᠬᠦ' }, { value: 1, status: 'ᠬᠡᠷᠡᠭᠯᠡᠬᠦ ᠪᠡᠨ ᠵᠤᠭᠰᠤᠬᠤ' }], // 启用停用
        rules: {
          place: [
            {
              required: true,
