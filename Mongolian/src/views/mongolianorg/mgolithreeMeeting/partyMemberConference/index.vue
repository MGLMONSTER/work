      ...
      <div class="app-table">
        <div class="filter-container">
          <div class="filter-input">
            ...
            <el-date-picker class="settimess" v-model="listQuery.beginTime" type="month"
                            :placeholder="$t('table.selectms')"><!--选择会议开始月 -->
            </el-date-picker>
            <el-input @keyup.enter.native="" class="filter-item" :placeholder="$t('table.hdzt')"
                                       v-model="listQuery.title"></el-input><!-- 活动主题 -->
        ...
        <!-- ***************************** 选择会议模板 ***************************** -->
        <el-dialog title="ᠨᠠᠮ  ᠤᠨ ᠡᠭᠦᠷ ᠦᠨ ᠨᠠᠮ ᠤᠨ ᠭᠡᠰᠢᠭᠦᠨ  ᠦ ᠳᠠᠶᠢᠴᠢᠯᠠᠯᠲᠠ ᠶᠢᠨ ᠬᠤᠷᠠᠯ " :visible.sync="dialogTemplate" width="auto" :close-on-click-modal="modalClose">
            ...
            <el-collapse @change="" v-model="activeNames" style="height: 100%;">
              <el-collapse-item name="1" class="collapse-button">
                <template slot="title">
                  ...
                  <span v-for="fileType in fileTypeNum" :key="fileType">
    ...
    data() {
      return {
        ...
        list: [{
          ...
          beginTime: '2018.08.23 10:36',
          endTime: '2018.08.23 12:36',
          deptId: '1',
        ...
        meet: {
          ...
          needApply: [
            { required: true, message: 'ᠲᠥᠷᠥᠯ ᠵᠦᠢᠯ ᠢᠶᠡᠨ ᠰᠤᠩᠭᠤᠭᠠᠷᠠᠢ' }// 请选择类型
          ],
  ...
  // 修改
    ...
    methods: {
      ...
      updateMeetStateMethod(row) {
        this.$confirm('ᠲᠤᠰ ᠠᠵᠢᠯᠯᠠᠭ᠎ᠠ ᠨᠢ ᠡᠨᠡ ᠤᠳᠠᠭᠠᠨ ᠤ ᠬᠥᠳᠡᠯᠭᠡᠭᠡᠨ ᠢ ᠬᠦᠴᠦᠨ ᠦᠭᠡᠢ ᠪᠣᠯᠭᠠᠨ᠎ᠠ ᠂ ᠵᠥᠪᠰᠢᠶᠡᠷᠡᠨ᠎ᠡ ᠤᠤ ？', 'ᠰᠠᠨᠠᠭᠤᠯᠭ᠎ᠠ', {
