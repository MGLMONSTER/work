<template>
  <section class="todoapp">
    <!-- header -->
    <header class="header">
      <input class="new-todo" autocomplete="off" placeholder="活动资讯" @keyup.enter="addTodo">
    </header>
    <!-- main section -->
...
const defalutList = [
  { text: 'XXX活动第二期开始提醒', done: false },
  { text: 'XXX活动顺利完结了', done: false },
  { text: 'XXX活动顺利开始了', done: false },
  { text: 'XXX活动总结和评价', done: true },
  { text: '组织活动人数', done: true },
  { text: 'XXX组织活动的感想', done: true }
]
export default {
  components: { Todo },
  data() {
