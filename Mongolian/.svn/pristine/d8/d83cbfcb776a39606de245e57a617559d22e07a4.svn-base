 <template>
  <div class="dealtdate-con">
    <!-- <div class="dangwugongkai11">
      <i  id="dangwugongkai11" style="font-size:30px;height:52px;color:white;padding:20px;line-height:52px;background:#E33434;" class="iconfont icon-dangwugongkai">
        <span id="dangwugongkai12" style="font-size:15px;background:#E33434;position:fixed;width:237px;">智慧党建平台</span></i>
    </div> -->
    <template>
        <el-card class="box-card" >
          ...
          <span style="display:block;width:30px;height:20px;color:#409eff;float:right;padding: 3px 0;font-size:15px; cursor:pointer;" type="text"> ᠭᠡᠮᠨᠡᠭ ᠳᠠᠪ</span>
        </el-card>
        <el-card class="box-card" style="writing-mode:horizontal-tb;width:30%;">
          <div slot="header" class="clearfix"  >
          ...
          <el-card class="box-card1" style="box-shadow:0px 0px 0px;border:0px">
            ...
            <span style="display:black;cursor:pointer;float: right; padding: 3px 0 ;color:#e03636;" type="text" > 查看更多 </span>
          </el-card>
        </el-card>
    </template>
  </div>
