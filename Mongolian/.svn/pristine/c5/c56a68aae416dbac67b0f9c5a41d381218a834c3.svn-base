const mutations = {
    ...
    ChangeInfoTree(state, val) {
        state.HeightHeight = val;
    },
    handleNodeClickId(state, val) {
        state.ZhiBIdInfoZz111 = val;
    },
    tableDataEndLength(state, val) {
        state.tableDataEndLength = val;
    },
    tableDataBegin(state, val) {
        state.tableDataBegin = val;
    },
    tableDataEnd(state, val) {
        state.tableDataEnd = val;
    },
    ZuzInfo(state, val) {
        state.ZuzInfo = val;
    },
    handleClick(state){
        state.SessInfoOne = false;
        state.SessInfoTwo = true;
    },
    handleClick_1(state){
        state.SessInfoTwo = false;
        state.SessInfoTwo1 = true;
    },
    handleClick_2(state){
        state.SessInfoOne = true;
        state.SessInfoTwo = false;
        state.SessInfoTwo1 = false;
    },
    handleClick_3(state){
        state.SessInfoOne = false;
        state.SessInfoTwo = true;
    ...
    SessInfoTwoChange(state){
        state.SessInfoOne = false;
        state.SessInfoTwo = true;
        state.SessInfoTwo1 = false;
    },
    ReturnInfoChange(state){
        state.ReturnInfo = false;
        state.ReturnInfoS = false;
    },
    SessInfoTwoChangeQ(state){
        state.SessInfoOne = false;
        state.SessInfoTwo = false;
        state.SessInfoTwo1 = true;
    },
    ReturnInfoChangeQ(state){
        state.ReturnInfoS = false;
        state.ReturnInfo = true;  
    },
    SecondLevel(state,val){
        state.SecondLevel = val
    },
    VillageVal(state,val){
        state.VillageVal = val;
    },
    SecondSteps(state,val){
        state.SecondSteps = val;
    },
    SecondTrue(state){
        state.SecondTrue = false;
    },
    SecondStepsInfo(state,val){
        state.SecondStepsInfo = val;
    },
    ReturnInfoChange12(state){
        state.ReturnInfo = true;
        state.ReturnInfoS = false;
    }
}
