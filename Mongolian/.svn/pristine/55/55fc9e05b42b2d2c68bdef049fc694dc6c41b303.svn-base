  ...
  <div class="appmain-righ">
    <div class='tab-div'>
      ...
      <div class="app-table">
        ...
        <!-- ***************************** 选择会议模板 ***************************** -->
        <el-dialog title="ᠠᠷᠠᠳᠴᠢᠯᠠᠭᠰᠠᠨ ᠠᠮᠢᠳᠤᠷᠠᠯ  ᠤᠨ ᠬᠤᠷᠠᠯ " :visible.sync="dialogTemplate" width="auto" :close-on-click-modal="modalClose">
    ...
    data() {
      return {
        ...
        meet: {
          ...
          endTime: [{ required: true, message: 'ᠳᠠᠭᠤᠰᠬᠤ ᠴᠠᠭ ᠢ ᠰᠣᠩᠭᠤᠭᠠᠷᠠᠢ', trigger: 'change' }], // 请选择结束时间 // 修改
          compere: [
